...
namespace EasyEDA_Loader
{
    public class EasyedaApi
    {
        ...
        public class PartInfo
        {
            ...
            /// <summary>JLCPCB SMT stock count (0 if unknown).</summary>
            public int Stock { get; set; }
            /// <summary>"Basic", "Extended", or empty if unknown.</summary>
            public string LibraryType { get; set; }
            public string Package { get; set; }
            public bool IsBasic =>
                string.Equals(LibraryType, "Basic", StringComparison.OrdinalIgnoreCase) ||
                string.Equals(LibraryType, "base", StringComparison.OrdinalIgnoreCase);
        }
